...
import logo from "../../../public/assets/images/coursify_logo.png";
...
function MyDropzone() {
  ...
  return (
    <Paper elevation={3} {...getRootProps()} className="p-6 border-2 border-dashed border-gray-300 bg-gray-100 rounded-md text-center cursor-pointer">
      <input {...getInputProps()} />
